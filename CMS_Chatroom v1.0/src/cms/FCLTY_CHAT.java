...
public class FCLTY_CHAT extends  javax.swing.JFrame
{
    static Socket s;
    ...
    private void sendbtn2ActionPerformed(java.awt.event.ActionEvent evt) 
    {//GEN-FIRST:event_sendbtn2ActionPerformed
      SendMsg(textbox2.getText());
    }//GEN-LAST:event_sendbtn2ActionPerformed

    private void textbox2ActionPerformed(java.awt.event.ActionEvent evt) 
    {//GEN-FIRST:event_textbox2ActionPerformed
        receive2=textbox2.getText();
    }//GEN-LAST:event_textbox2ActionPerformed

    private void savechat2ActionPerformed(java.awt.event.ActionEvent evt) 
    {//GEN-FIRST:event_savechat2ActionPerformed
        DownloadChat(msg_area2.getText().toString());
    ...
    public static void main(String args[]) 
    {
        ...
        {
            java.util.logging.Logger.getLogger(FCLTY_CHAT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() 
        {
            public void run() 
            {
                new FCLTY_CHAT().setVisible(true);
    ...
    void DownloadChat(String str)
    {
        String msg1 = str;
        try
        {
            BufferedWriter writer = new BufferedWriter(new FileWriter("./StudentChat_Record.txt"));            
            writer.write(msg1);
            writer.close();
    ...
    void SendMsg(String message)
    {
        ...
        try
        {
            DB_Connectivity c = new DB_Connectivity();
            con=c.connectDB();
            if(con!=null)
            {
                Statement state = con.createStatement();
                state.executeQuery("insert into TeacherChat values('"+message+"')");
