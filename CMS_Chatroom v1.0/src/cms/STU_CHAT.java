...
public class STU_CHAT extends javax.swing.JFrame 
{
    static Socket s;
    ...
    {//GEN-FIRST:event_jButton2ActionPerformed
       DownloadChat(msg_area.getText().toString());
    }//GEN-LAST:event_jButton2ActionPerformed

    private void textboxActionPerformed(java.awt.event.ActionEvent evt) 
    {//GEN-FIRST:event_textboxActionPerformed
    ...
    public static void main(String args[]) 
    {
        try 
        {
            ...
            java.util.logging.Logger.getLogger(STU_CHAT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    String DownloadChat(String str)
    {
        String msg1 = str;
        try
        {
    ...
    String SendMsg(String message)
    {
        ...
        try
        {
            ...
            if(con!=null)
            {
                ...
                state.executeQuery("insert into StudentChat values('"+message+"')");
