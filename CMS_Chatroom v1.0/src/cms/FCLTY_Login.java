...
public class FCLTY_Login extends javax.swing.JFrame {
   ...
   static String temp1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FCLTY_Login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FCLTY_Login().setVisible(true);
            }
        });
    }
    ...
    void Login(String username,String password){
     ...
     try{
        ...
        String sql = "select* from FacultyLogin where(name='"+username+"' and password='"+password+"')";
